...
export type FileFieldsEnum = 
  ...
  'childMarkdownRemark___frontmatter___intro' |
  ...
  'childMarkdownRemark___frontmatter___featuredwork' |
...
export type MarkdownRemarkFrontmatter = {
  ...
  description?: Maybe<Scalars['String']>,
  featuredwork?: Maybe<Scalars['Boolean']>,
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  description?: Maybe<StringQueryOperatorInput>,
  featuredwork?: Maybe<BooleanQueryOperatorInput>,
  featuredimage?: Maybe<FileFilterInput>,
  images?: Maybe<FileFilterInput>,
};
...
export type SeoQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'siteUrl'>> }> };

export type WorksQueryQueryVariables = {};


export type WorksQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
        & { frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'path' | 'description'>
          & { featuredimage: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }
        )> }
      ) }> } };
...
export type IndexQueryQuery = { allFile: { edges: Array<{ node: { childMarkdownRemark: Maybe<{ frontmatter: Maybe<(
            Pick<MarkdownRemarkFrontmatter, 'title' | 'intro'>
            & { image: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }
          )> }> } }> }, allImageSharp: { edges: Array<{ node: { fluid: Maybe<GatsbyImageSharpFluid_WithWebpFragment> } }> } };

export type WorkPostByIdQueryVariables = {
  id?: Maybe<Scalars['String']>
};


export type WorkPostByIdQuery = { markdownRemark: Maybe<(
